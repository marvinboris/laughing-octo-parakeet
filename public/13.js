...
/***/ "./resources/js/src/containers/Backend/Admin/Expenses/index.js":
/*!*********************************************************************!*\
  !*** ./resources/js/src/containers/Backend/Admin/Expenses/index.js ***!
  \*********************************************************************/
/*! exports provided: default */
  ...
  _createClass(Index, [{
    ...
    value: function render() {
      ...
      var _this$props = this.props,
          ...
          amount = _this$props$content$c4.amount,
          method = _this$props$content$c4.method,
          category = _this$props$content$c4.category,
          user = _this$props$content$c4.user,
          proof = _this$props$content$c4.proof,
          ...
          expenses = _this$props$backend$e.expenses,
      ...
      var data = expenses.map(function (expense) {
        return Object(_shared_utility__WEBPACK_IMPORTED_MODULE_15__["updateObject"])(expense, {
          // date: convertDate(expense.date),
          proof: expense.proof && /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("div", {
            className: "d-flex"
          ...
          action: /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("div", {
            ...
            to: "/admin/expenses/".concat(expense.id),
            className: "mr-2"
          }, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(_fortawesome_react_fontawesome__WEBPACK_IMPORTED_MODULE_4__["FontAwesomeIcon"], {
            icon: _fortawesome_free_solid_svg_icons__WEBPACK_IMPORTED_MODULE_5__["faEye"],
            ...
            to: "/admin/expenses/".concat(expense.id, "/edit"),
            className: "mr-2"
          }, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(_fortawesome_react_fontawesome__WEBPACK_IMPORTED_MODULE_4__["FontAwesomeIcon"], {
            ...
            deleteAction: function deleteAction() {
              return _this.props["delete"](expense.id);
            }
          }, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(_fortawesome_react_fontawesome__WEBPACK_IMPORTED_MODULE_4__["FontAwesomeIcon"], {
...
var mapDispatchToProps = function mapDispatchToProps(dispatch) {
  return {
    get: function get(page, show, search) {
      return dispatch(_store_actions__WEBPACK_IMPORTED_MODULE_14__["getExpenses"](page, show, search));
    },
    "delete": function _delete(id) {
      return dispatch(_store_actions__WEBPACK_IMPORTED_MODULE_14__["deleteExpenses"](id));
    },
    reset: function reset() {
      return dispatch(_store_actions__WEBPACK_IMPORTED_MODULE_14__["resetExpenses"]());
    }
  };
};
