...
/***/ "./resources/js/src/containers/Backend/Admin/Quarters/index.js":
/*!*********************************************************************!*\
  !*** ./resources/js/src/containers/Backend/Admin/Quarters/index.js ***!
  \*********************************************************************/
  ...
  _createClass(Index, [{
    ...
    value: function render() {
      ...
      var _this$props = this.props,
          ...
          _this$props$content$c2 = _this$props$content$c.backend.pages.quarters,
          ...
          city = _this$props$content$c3.city,
          created_at = _this$props$content$c3.created_at,
          _this$props$backend$q = _this$props.backend.quarters,
          loading = _this$props$backend$q.loading,
          error = _this$props$backend$q.error,
          message = _this$props$backend$q.message,
          quarters = _this$props$backend$q.quarters,
          total = _this$props$backend$q.total;
      var content;
      var errors;
      var feedback;
      ...
      var data = quarters.map(function (quarter) {
        return Object(_shared_utility__WEBPACK_IMPORTED_MODULE_14__["updateObject"])(quarter, {
          created_at: Object(_shared_utility__WEBPACK_IMPORTED_MODULE_14__["convertDate"])(quarter.created_at),
          action: /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("div", {
            className: "text-center"
          }, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(react_router_dom__WEBPACK_IMPORTED_MODULE_2__["Link"], {
            to: "/admin/quarters/".concat(quarter.id),
            className: "mr-2"
            ...
            to: "/admin/quarters/".concat(quarter.id, "/edit"),
            className: "mr-2"
          }, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(_fortawesome_react_fontawesome__WEBPACK_IMPORTED_MODULE_4__["FontAwesomeIcon"], {
            ...
            deleteAction: function deleteAction() {
              return _this.props["delete"](quarter.id);
            }
          }, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(_fortawesome_react_fontawesome__WEBPACK_IMPORTED_MODULE_4__["FontAwesomeIcon"], {
      ...
      content = /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(react__WEBPACK_IMPORTED_MODULE_0___default.a.Fragment, null, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(reactstrap__WEBPACK_IMPORTED_MODULE_3__["Row"], null, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(_components_Backend_UI_List_List__WEBPACK_IMPORTED_MODULE_9__["default"], {
        array: data,
        loading: loading,
        data: JSON.stringify(quarters),
        get: this.props.get,
        total: total,
        bordered: true,
        add: add,
        link: "/admin/quarters/add",
...
var mapDispatchToProps = function mapDispatchToProps(dispatch) {
  return {
    get: function get(page, show, search) {
      return dispatch(_store_actions__WEBPACK_IMPORTED_MODULE_13__["getQuarters"](page, show, search));
    },
    "delete": function _delete(id) {
      return dispatch(_store_actions__WEBPACK_IMPORTED_MODULE_13__["deleteQuarters"](id));
    },
    reset: function reset() {
      return dispatch(_store_actions__WEBPACK_IMPORTED_MODULE_13__["resetQuarters"]());
    }
  };
};
