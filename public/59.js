...
/***/ "./resources/js/src/containers/Backend/User/Cities/index.js":
/*!******************************************************************!*\
  !*** ./resources/js/src/containers/Backend/User/Cities/index.js ***!
  \******************************************************************/
  ...
  _createClass(Index, [{
    ...
    value: function render() {
      ...
      var _this$props = this.props,
          ...
          _this$props$content$c2 = _this$props$content$c.backend.pages.cities,
          ...
          _this$props$backend$c = _this$props.backend.cities,
      ...
      var data = cities.map(function (city) {
        return Object(_shared_utility__WEBPACK_IMPORTED_MODULE_14__["updateObject"])(city, {
          created_at: Object(_shared_utility__WEBPACK_IMPORTED_MODULE_14__["convertDate"])(city.created_at),
          action: /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("div", {
            className: "text-center"
          }, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(react_router_dom__WEBPACK_IMPORTED_MODULE_2__["Link"], {
            to: "/user/cities/".concat(city.id),
            className: "mx-1"
            ...
            to: "/user/cities/".concat(city.id, "/edit"),
            className: "mx-1"
          }, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(_fortawesome_react_fontawesome__WEBPACK_IMPORTED_MODULE_4__["FontAwesomeIcon"], {
...
var mapDispatchToProps = function mapDispatchToProps(dispatch) {
  return {
    get: function get(page, show, search) {
      return dispatch(_store_actions__WEBPACK_IMPORTED_MODULE_13__["getCities"](page, show, search));
    },
    "delete": function _delete(id) {
      return dispatch(_store_actions__WEBPACK_IMPORTED_MODULE_13__["deleteCities"](id));
    },
    reset: function reset() {
      return dispatch(_store_actions__WEBPACK_IMPORTED_MODULE_13__["resetCities"]());
    }
  };
};
