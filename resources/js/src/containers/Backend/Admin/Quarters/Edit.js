...
class Edit extends Component {
    ...
    render() {
        let {
            ...
            backend: { quarters: { loading, error, message, cities } } } = this.props;
        ...
        if (loading) content = <Col xs={12}>
            ...
            content = (
                <>
                    <Row>
                        <Form onSubmit={this.submitHandler} icon={faBuilding} title={edit} list={index} link="/admin/quarters" innerClassName="row" className="shadow-sm">
                            <Col lg={8}>
        ...
        return (
            <>
                <div className="bg-soft py-4 pl-5 pr-4 position-relative">
                    <Breadcrumb items={[{ to: '/admin/quarters', content: index }]} main={edit} icon={faBuilding} />
