    ...
    render() {
        ...
        if (loading) content = <Col xs={12}>
            ...
            content = (
                <>
                    <Row>
                        <Form onSubmit={this.submitHandler} icon={faMoneyBillWaveAlt} title={edit} list={index} link="/user/expenses" innerClassName="row" className="shadow-sm">
                            <Col lg={8}>
        ...
        return (
            <>
                <div className="bg-soft py-4 pl-5 pr-4 position-relative">
                    <Breadcrumb items={[{ to: '/user/expenses', content: index }]} main={edit} icon={faMoneyBillWaveAlt} />
