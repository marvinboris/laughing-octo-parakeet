    ...
    render() {
        ...
        if (loading) content = <Col xs={12}>
            ...
            content = (
                <>
                    <Row>
                        <Form onSubmit={this.submitHandler} icon={faLanguage} title={edit} list={index} link="/user/languages" innerClassName="row" className="shadow-sm">
                            <Col lg={8}>
        ...
        return (
            <>
                <div className="bg-soft py-4 pl-5 pr-4 position-relative">
                    <Breadcrumb items={[{ to: '/user/languages', content: index }]} main={edit} icon={faLanguage} />
