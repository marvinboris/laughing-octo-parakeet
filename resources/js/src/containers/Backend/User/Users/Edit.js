    ...
    render() {
        ...
        if (loading) content = <Col xs={12}>
            ...
            content = (
                <>
                    <Row>
                        <Form onSubmit={this.submitHandler} icon={faUser} title={edit} list={index} link="/user/users" innerClassName="row" className="shadow-sm">
                            <Col lg={8}>
        ...
        return (
            <>
                <div className="bg-soft py-4 pl-5 pr-4 position-relative">
                    <Breadcrumb items={[{ to: '/user/users', content: index }]} main={edit} icon={faUser} />
